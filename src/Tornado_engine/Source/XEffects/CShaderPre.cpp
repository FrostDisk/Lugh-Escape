...
namespace Tornado
{
	namespace XEffects
	{
		...
		void CShaderPreprocessor::addShaderDefine(const irr::core::stringc name, const irr::core::stringc value)
		{
		...
		irr::core::stringc CShaderPreprocessor::ppShader(irr::core::stringc shaderProgram)
		{
		...
		//! PreProcesses a shader using Irrlicht's built-in shader preprocessor.
		irr::core::stringc CShaderPreprocessor::ppShaderFF(irr::core::stringc shaderProgram)
		{
